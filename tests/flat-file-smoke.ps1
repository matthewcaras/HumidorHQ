...
# Changelog :
# 1.32.24 align smoke test cache-bust pin with app.js 1.24.29
...
if ($index -notmatch 'public/assets/js/app\.js\?v=1\.24\.29') { throw 'index.html does not load cache-busted public/assets/js/app.js.' }
