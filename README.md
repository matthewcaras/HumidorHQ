...
- Signed-in user, logout controls, Mobile preview access, project revision, a stacked modified date/time, and a Close Menu/Open Menu collapsible control sit in the sidebar on desktop; on mobile, the account and revision footer moves below the content.
